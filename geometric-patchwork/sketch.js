    ...
    for (let y = 0; y < height; y += gridSize) {
      ...
      switch (round(random(0.51, 9.49))) {
        ...
        case 3:
          ...
          break;
        case 4:
          triangle(x, y, x, y + gridSize, x + gridSize, y + gridSize);
          break;
        case 5:
          arc(x + gridSize / 2, y + gridSize / 2, gridSize, gridSize, 0, 180);
          break;
        case 6:
          arc(x + gridSize / 2, y + gridSize / 2, gridSize, gridSize, 90, 270);
          break;
        case 7:
          arc(x + gridSize / 2, y + gridSize / 2, gridSize, gridSize, 180, 0);
          break;
        case 8:
          arc(x + gridSize / 2, y + gridSize / 2, gridSize, gridSize, 270, 90);
          break;
        case 9:
...
function keyPressed() {
  if (keyCode >= 49 && keyCode <= 57) {
    ...
    redraw();
    let fname = "geometric-patchwork-" + key + ".png";
    save(fname);
  }
}
